...
state — the data presence requirement; the _transitions_ and their
...
ordering assumption as a _binding_ — `Audio.where({ report })`
...
is _raw material_: it is the Amharic text version of the recorded
